...
class ps_html extends tr_base {
   ...
   * @return array|string
   */
  static function imagePicker($tag, $args, $html = null, $make = true) {
  	$imagePicker = '<div class="button-group">
  ...
  static function make_html_attr($attr, $value='') {
    ...
    if(isset($value)) { return "{$attr}=\"{$value}\""; }
    else { return ''; }
  }
